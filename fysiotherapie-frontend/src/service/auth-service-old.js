...
export default class AuthServiceOld {
    ...
    logout() {
        ...
        AuthServiceOld.handleNavbarVisibility(); // hides navbar after logging out
    }
    ...
    static handleNavbarVisibility() {
        ...
        if (sidebar) {
            sidebar._isLoggedIn = AuthServiceOld.isLoggedIn();
        }
    }
    ...
    //
    //     // if (sidebar) {
    //     //     sidebar._isLoggedIn = AuthServiceOld.isLoggedIn(); // Directly set visibility based on logged-in status
